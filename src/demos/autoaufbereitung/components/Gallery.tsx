...
const Gallery: React.FC<GalleryProps> = ({ isPreviewMode = false }) => {
  ...
  const galleryImages = [
    {
      ...
      type: 'image',
      title: 'Luxus Fahrzeugpflege',
      category: 'Außenreinigung'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      type: 'image',
      title: 'Porsche 911',
      category: 'Supercar Pflege'
    },
    {
      id: 6,
      image: 'https://images.pexels.com/photos/1592384/pexels-photo-1592384.jpeg?auto=compress&cs=tinysrgb&w=800',
      type: 'image',
      title: 'McLaren Supersportwagen',
      category: 'Premium Wäsche'
    },
    {
      id: 7,
      image: 'https://images.pexels.com/photos/3802510/pexels-photo-3802510.jpeg?auto=compress&cs=tinysrgb&w=800',
    ...
    },
    {
      ...
      category: 'Performance Detailing'
    },
    {
      id: 10,
      image: 'https://images.pexels.com/photos/3802510/pexels-photo-3802510.jpeg?auto=compress&cs=tinysrgb&w=800',
            ...
            {(galleryImages[selectedImage].title || galleryImages[selectedImage].category) && (
              <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-sm rounded-xl p-4 text-white">
                {galleryImages[selectedImage].category && (
                  <span className="inline-block px-3 py-1 bg-gradient-metallic text-slate-700 text-sm font-medium rounded-full shadow-silver mb-2">
                    {galleryImages[selectedImage].category}
                  </span>
                )}
