...
const MapSection: React.FC<MapSectionProps> = ({ customData = {}, isPreviewMode = false }) => {
  ...
  const businessAddress = getContent('contact_address', "Musterstraße 123, 12345 Musterstadt").replace(/\n/g, ' ');
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-silver-xl overflow-hidden border border-white/50 relative h-96 md:h-[500px] lg:h-[600px]">
              ...
              <div className="relative z-10 h-full">
                <iframe
                  ...
                  title="AutoPflege Profi Standort"
                ></iframe>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 lg:overflow-y-auto lg:h-[600px] lg:pr-2">
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-silver-lg p-6 border border-white/50 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p id="demo-contact-address" data-editable="contact_address" className="text-slate-700 font-poppins mb-4 whitespace-pre-line">
                  {getContent('contact_address', 'Musterstraße 123\n12345 Musterstadt')}
                </p>
                <a
                  href={directionsUrl}
                  target="_blank"
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <a id="demo-contact-phone" data-editable="contact_phone" href={`tel:${getContent('contact_phone', '0123 456 7890').replace(/\s/g, '')}`} className="text-slate-900 font-semibold hover:text-red-600 transition-colors font-poppins">
                      {getContent('contact_phone', '0123 456 7890')}
                    </a>
                  </div>
                  <div>
                    <p className="text-slate-600 text-sm font-poppins">E-Mail</p>
                    <a id="demo-contact-email" data-editable="contact_email" href={`mailto:${getContent('contact_email', 'info@autopflege-profi.de')}`} className="text-slate-900 font-semibold hover:text-red-600 transition-colors font-poppins break-all">
                      {getContent('contact_email', 'info@autopflege-profi.de')}
                    </a>
                  </div>
                </div>
              </div>
