...
const Gallery: React.FC = () => {
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      type: 'image',
      title: 'Heckenschnitt Perfektion',
      category: 'Heckenpflege'
    },
    {
      id: 4,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-green-400/30 shadow-lg animate-glow flex items-center justify-center relative overflow-hidden border border-green-400">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-green-400/30 to-transparent animate-shimmer"></div>
                <Eye className="w-6 h-6 text-green-300 relative z-10" />
              </div>
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-green-200 to-green-300 bg-clip-text text-transparent font-poppins">
                Zufriedene Kunden
              </h2>
            </div>
            <p className="text-xl text-green-100 max-w-3xl mx-auto font-montserrat">
              So schön war Ihr Garten noch nie – überzeugen Sie sich selbst!
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
          {galleryImages.map((item, index) => (
            <div
              key={item.id}
              className={`group relative overflow-hidden rounded-2xl bg-green-800/50 backdrop-blur-sm border border-green-700/50 hover:border-green-500/50 transition-all duration-500 hover:scale-105 cursor-pointer ${
            ...
            >
              ...
              {/* Hover Glow Effect */}
              <div className="absolute inset-0 rounded-2xl transition-all duration-500 pointer-events-none group-hover:shadow-lg shadow-green-400/20"></div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <div className="bg-green-800/50 backdrop-blur-xl rounded-3xl p-8 border border-green-700/50 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 font-poppins">
                Lust auf den gleichen Wow-Effekt? Jetzt Gartengestaltung buchen.
              </h3>
              <p className="text-green-100 mb-6 max-w-2xl mx-auto font-montserrat">
                Lassen Sie uns auch Ihren Garten in eine grüne Oase verwandeln
              </p> 
              <a
                href="/configurator"
                className="group relative inline-flex items-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl overflow-hidden"
              >
            ...
            {(galleryImages[selectedImage].title || galleryImages[selectedImage].category) && (
              <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-sm rounded-xl p-4 text-white">
                {galleryImages[selectedImage].category && (
                  <span className="inline-block px-3 py-1 bg-green-400/30 text-green-300 text-sm font-medium rounded-full border border-green-400 mb-2">
                    {galleryImages[selectedImage].category}
                  </span>
                )}
