...
import { ArrowRight, CheckCircle, Star, Shield, Clock, Phone, Mail, MapPin, Sparkles, Users, Award, Zap, Camera, Brush, Wrench, Building, Leaf, FileText, MessageSquare, ThumbsUp, Heart, ChevronRight, Home, Calculator, TrendingUp, Gift, Timer, Euro, Percent, Play, ChevronDown, Gauge, Smile, MessageCircle, Scissors, Palette, Crown, Settings } from 'lucide-react';
...
const Landing = () => {
  ...
  const themeConfig = {
    modern: {
      ...
      bgGradient: 'from-black via-pink-900/20 to-black',
    ...
    elegant: {
      ...
      bgGradient: 'from-black via-rose-900/20 to-black',
    ...
    <div className={`min-h-screen bg-black text-white relative overflow-hidden ${isPreviewMode ? 'preview-mode' : ''}`}>
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span className="text-white font-medium font-poppins">Beauty & Friseur #1</span>
              </motion.div>
              ...
              >
                Beauty & Friseur{' '}
                <span
                  className={`block md:inline bg-gradient-to-r ${currentTheme.gradientFrom} via-purple-500 ${currentTheme.gradientTo} bg-clip-text text-transparent animate-pulse`}
              ...
              >
                Verwöhnen Sie sich mit unseren professionellen Beauty- und Friseur-Services für ein strahlendes Aussehen.
              </motion.p>
              ...
              >
                {[
                  ...
                  { icon: Sparkles, text: 'Alle Beauty Services', highlight: true },
                  { icon: Crown, text: 'Premium Behandlung', highlight: true }
                ].map((item, index) => (
                  <div key={index} className={`flex items-center gap-2 backdrop-blur-sm rounded-lg p-3 border transition-all hover:scale-105 ${
                    ...
                    <item.icon className={`w-5 h-5 ${item.highlight ? 'text-pink-300' : 'text-gray-300'}`} />
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-poppins">Damen & Herren</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4" />
                  <span className="text-sm font-poppins">Ø Schnelle Termine</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                ...
                <div className="flex items-center gap-2 text-gray-600">
                  ...
                  <span className="font-semibold text-pink-600">25 Bewertungen</span>
                </div>
        ...
        <section className={`py-24 bg-gradient-to-b from-${currentTheme.primaryColor}-900 to-black relative`}>
          <div className={`absolute inset-0 bg-gradient-to-r from-${currentTheme.primaryColor}-500/5 to-purple-500/5`}></div>
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-poppins">
                  Welche Beauty-Behandlung brauchen Sie?
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto font-poppins">
                  Wählen Sie aus unserem professionellen Beauty-Angebot - von der Gesichtsbehandlung bis zum kompletten Styling
                </p>
              </motion.div>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Professioneller Haarschnitt und Styling für Damen und Herren. Moderne Schnitte und individuelle Beratung für Ihren perfekten Look.',
                  beforeImage: 'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Scissors,
                  features: ['Beratung & Analyse','Waschen & Schneiden','Styling & Föhnen','Pflegetipps','Nachbehandlung'],  
                  duration: '60-90 Min',
                },
                {
                  title: 'Coloration',
                  description: 'Professionelle Haarfarbe und Strähnchen. Von natürlichen Tönen bis zu kreativen Farben - wir setzen Ihre Wünsche um.',
                  beforeImage: 'https://images.pexels.com/photos/3065209/pexels-photo-3065209.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Palette,
                  features: ['Farbberatung', 'Strähnchen', 'Komplettcoloration', 'Tönungen', 'Glossing'],
                  duration: '90-150 Min',
                },
                {
                  title: 'Gesichtsbehandlung',
                  description: 'Entspannende und pflegende Gesichtsbehandlungen für alle Hauttypen. Reinigung, Peeling und intensive Pflege.',
                  beforeImage: 'https://images.pexels.com/photos/3757942/pexels-photo-3757942.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Sparkles,
                  features: ['Hautanalyse', 'Tiefenreinigung','Peeling', 'Maske', 'Pflege'],
                  duration: '60-90 Min',
                },
                {
                  title: 'Maniküre & Pediküre',
                  description: 'Professionelle Hand- und Fußpflege. Perfekte Nägel und gepflegte Hände und Füße für jeden Anlass.',
                  beforeImage: 'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Crown,
                  features: ['Nagelpflege', 'Lackierung', 'French Maniküre', 'Gel-Nägel', 'Nageldesign'],
                  duration: '45-75 Min',
                },
                {
                  title: 'Permanent Make-up',
                  description: 'Langanhaltende Schönheit mit Permanent Make-up. Augenbrauen, Lidstrich und Lippen professionell pigmentiert.',
                  beforeImage: 'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Brush,
                  features: ['Augenbrauen', 'Lidstrich', 'Lippen', 'Beratung', 'Nachbehandlung'],
                  duration: '120-180 Min',
                },
                {
                  title: 'Hochzeitsstyling',
                  description: 'Komplettes Brautstyling für den schönsten Tag im Leben. Haare, Make-up und Beratung für den perfekten Look.',
                  beforeImage: 'https://images.pexels.com/photos/1043473/pexels-photo-1043473.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Heart,
                  features: ['Brautstyling', 'Probe-Styling', 'Make-up', 'Haarstyling', 'Begleitung'],
            ...
            <div className="text-center mt-12">
              <div className={`bg-gradient-to-r from-${currentTheme.primaryColor}-500/10 to-purple-500/10 rounded-2xl p-8 border border-${currentTheme.primaryColor}-500/20`}>
                <h3 className="text-2xl font-bold mb-4 text-white font-poppins">Nicht sicher welche Behandlung Sie brauchen?</h3>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto font-poppins">
                  Unsere Beauty-Experten beraten Sie kostenlos und finden die perfekte Behandlung für Ihre Bedürfnisse.
                </p>
      ...
      {isAIChatbotEnabled && (
        <div className="fixed bottom-6 left-6 z-40">
          ...
          <div className="absolute bottom-16 left-0 bg-white text-gray-800 p-3 rounded-lg shadow-lg max-w-xs opacity-0 hover:opacity-100 transition-opacity duration-300">
            <p className="text-sm font-medium">Hallo! Ich bin Ihr Beauty-KI-Assistent. Wie kann ich Ihnen helfen?</p>
          </div>
        </div>
      )}
