    ...
    <section className="py-24 bg-gradient-to-br from-red-900 via-red-800 to-red-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-red-400/30 shadow-lg animate-glow flex items-center justify-center relative overflow-hidden border border-red-400">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-red-400/30 to-transparent animate-shimmer"></div>
            <MapPin className="w-8 h-8 text-red-300 relative z-10" />
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 font-poppins">
            Besuchen Sie uns
          </h2>
          <p className="text-xl text-red-100 font-poppins">
            SecureProfi
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[600px]">
          ...
          <div className="lg:col-span-2 lg:sticky lg:top-8 lg:h-fit">
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-lg overflow-hidden border border-white/50 relative h-96 md:h-[500px] lg:h-[600px]">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-red-400/10 to-transparent opacity-10 animate-shimmer"></div>
          ...
          <div className="space-y-6 lg:overflow-y-auto lg:h-[600px] lg:pr-2">
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-white/50 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-poppins"
                >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <a href="tel:01234567890" className="text-slate-900 font-semibold hover:text-red-600 transition-colors font-poppins">
                      0123 456 7890
                    </a>
                  </div>
                  <div>
                    <p className="text-slate-600 text-sm font-poppins">E-Mail</p>
                    <a href="mailto:info@secureprofi.de" className="text-slate-900 font-semibold hover:text-red-600 transition-colors font-poppins break-all">
                      info@secureprofi.de
                    </a>
                  </div>
                </div>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-2 text-slate-700 font-poppins">
                  ...
                  <div className="flex justify-between border-t pt-2 mt-2">
                    <span>Notdienst:</span>
                    <span className="font-semibold text-red-600">24h verfügbar</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-6 text-white text-center">
              <h4 className="text-lg font-bold mb-2 font-poppins">Sicherheitsberatung</h4>
              <p className="text-red-100 text-sm mb-4 font-poppins">
                Rufen Sie uns an oder kommen Sie vorbei
              </p>
              <a
                href="/configurator"
                className="inline-block bg-white text-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-red-50 transition-colors font-poppins"
              >
                Website kaufen
              </a>
            </div>
