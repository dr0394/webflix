...
const Gallery: React.FC = () => {
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      type: 'image',
      title: 'Balkongeländer Edelstahl',
      category: 'Balkone'
    },
    {
      id: 5,
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-gray-400/30 shadow-lg animate-glow flex items-center justify-center relative overflow-hidden border border-gray-400">
                ...
                <Eye className="w-6 h-6 text-gray-300 relative z-10" />
              </div>
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-gray-200 to-gray-300 bg-clip-text text-transparent font-poppins">
                Unsere Metallbau-Projekte
              </h2>
            </div>
            <p className="text-xl text-gray-100 max-w-3xl mx-auto font-montserrat">
              So präzise war Ihr Metallbau noch nie – überzeugen Sie sich selbst!
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
          {galleryImages.map((item, index) => (
            ...
            >
              ...
              {/* Hover Glow Effect */}
              <div className="absolute inset-0 rounded-2xl transition-all duration-500 pointer-events-none group-hover:shadow-lg shadow-gray-400/20"></div>
            </div>
          ))}
        </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/50 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 font-poppins">
                Lust auf den gleichen Wow-Effekt? Jetzt Metallbau-Projekt buchen.
              </h3>
            ...
            {(galleryImages[selectedImage].title || galleryImages[selectedImage].category) && (
              <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-sm rounded-xl p-4 text-white">
                {galleryImages[selectedImage].category && (
                  <span className="inline-block px-3 py-1 bg-gray-400/30 text-gray-300 text-sm font-medium rounded-full border border-gray-400 mb-2">
                    {galleryImages[selectedImage].category}
                  </span>
                )}
