    ...
    <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-gray-400/30 shadow-lg animate-glow flex items-center justify-center relative overflow-hidden border border-gray-400">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/30 to-transparent animate-shimmer"></div>
            <MapPin className="w-8 h-8 text-gray-300 relative z-10" />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[600px]">
          ...
          <div className="lg:col-span-2 lg:sticky lg:top-8 lg:h-fit">
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-lg overflow-hidden border border-white/50 relative h-96 md:h-[500px] lg:h-[600px]">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/10 to-transparent opacity-10 animate-shimmer"></div>
          ...
          <div className="space-y-6 lg:overflow-y-auto lg:h-[600px] lg:pr-2">
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-white/50 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors font-poppins"
                >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <a href="tel:01234567890" className="text-slate-900 font-semibold hover:text-gray-600 transition-colors font-poppins">
                      0123 456 7890
                    </a>
                  </div>
                  <div>
                    <p className="text-slate-600 text-sm font-poppins">E-Mail</p>
                    <a href="mailto:info@metallprofi.de" className="text-slate-900 font-semibold hover:text-gray-600 transition-colors font-poppins break-all">
                      info@metallprofi.de
                    </a>
                  </div>
                </div>
            ...
            {/* CTA Button */}
            <div className="bg-gradient-to-r from-gray-600 to-gray-700 rounded-2xl p-6 text-white text-center">
              <h4 className="text-lg font-bold mb-2 font-poppins">Projekt besprechen</h4>
              <p className="text-gray-100 text-sm mb-4 font-poppins">
                Rufen Sie uns an oder kommen Sie vorbei
              </p>
              <a
                href="/configurator"
                className="inline-block bg-white text-gray-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors font-poppins"
              >
                Website kaufen
              </a>
            </div>
