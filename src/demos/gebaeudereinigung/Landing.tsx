...
import { ArrowRight, CheckCircle, Star, Shield, Clock, Phone, Mail, MapPin, Building, Users, Award, Zap, Camera, Brush, Wrench, Leaf, FileText, MessageSquare, ThumbsUp, Heart, ChevronRight, Home, Calculator, TrendingUp, Gift, Timer, Euro, Percent, Play, ChevronDown, Gauge, Smile, MessageCircle, Sparkles, Droplets, Settings } from 'lucide-react';
...
const Landing = () => {
  ...
  const themeConfig = {
    ...
    corporate: {
      ...
      gradientTo: 'to-blue-600',
      bgGradient: 'from-black via-indigo-900/20 to-black',
    ...
    fresh: {
      ...
      gradientTo: 'to-blue-600',
      bgGradient: 'from-black via-cyan-900/20 to-black',
    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <div 
              ...
              style={{ 
                backgroundImage: `url('https://images.pexels.com/photos/4099467/pexels-photo-4099467.jpeg?auto=compress&cs=tinysrgb&w=1600')`,
              }}
            />
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span className="text-white font-medium font-poppins">Gebäudereinigung #1</span>
              </motion.div>
              ...
              >
                ...
                <span
                  className={`block md:inline bg-gradient-to-r ${currentTheme.gradientFrom} via-cyan-500 ${currentTheme.gradientTo} bg-clip-text text-transparent animate-pulse`}
              ...
              >
                Vertrauen Sie auf unsere professionelle Gebäudereinigung für saubere und hygienische Räumlichkeiten.
              </motion.p>
              ...
              >
                {[
                  ...
                  { icon: Clock, text: 'Flexible Zeiten', highlight: true },
                  { icon: Star, text: '5/5 Sterne', highlight: false },
                  { icon: Building, text: 'Alle Gebäudetypen', highlight: true },
                  ...
                  <div key={index} className={`flex items-center gap-2 backdrop-blur-sm rounded-lg p-3 border transition-all hover:scale-105 ${
                    ...
                    <item.icon className={`w-5 h-5 ${item.highlight ? 'text-blue-300' : 'text-gray-300'}`} />
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-poppins">Büros & Praxen</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4" />
                  <span className="text-sm font-poppins">Flexible Zeiten</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="font-semibold text-blue-600">28 Bewertungen</span>
              </div>
        ...
        <section className={`py-24 bg-gradient-to-b from-${currentTheme.primaryColor}-900 to-black relative`}>
          <div className={`absolute inset-0 bg-gradient-to-r from-${currentTheme.primaryColor}-500/5 to-cyan-500/5`}></div>
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              >
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto font-poppins">
                  Wählen Sie aus unserem professionellen Reinigungsservice - von der Büroreinigung bis zur Grundreinigung
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  title: 'Büroreinigung',
                  description: 'Professionelle Reinigung von Büroräumen, Praxen und Verwaltungsgebäuden. Täglich, wöchentlich oder nach Bedarf.',
                  beforeImage: 'https://images.pexels.com/photos/4099467/pexels-photo-4099467.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Building,
                  features: ['Arbeitsplätze','Sanitäranlagen','Küchen','Böden','Fenster'],  
                  duration: 'Täglich/Wöchentlich',
                },
                {
                  title: 'Treppenhausreinigung',
                  description: 'Gründliche Reinigung von Treppenhäusern und Eingangsbereichen. Für einen gepflegten ersten Eindruck.',
                  beforeImage: 'https://images.pexels.com/photos/2724749/pexels-photo-2724749.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Home,
                  features: ['Treppen & Geländer', 'Eingangsbereiche', 'Briefkästen', 'Beleuchtung', 'Aufzüge'],
                  duration: 'Wöchentlich',
                },
                {
                  title: 'Fensterreinigung',
                  description: 'Professionelle Fensterreinigung für kristallklare Sicht. Innen und außen, auch in großen Höhen.',
                  beforeImage: 'https://images.pexels.com/photos/4099467/pexels-photo-4099467.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Sparkles,
                  features: ['Innen & Außen', 'Rahmenreinigung','Höhenarbeiten', 'Streifenfrei', 'Regelmäßig'],
                  duration: 'Monatlich',
                },
                {
                  title: 'Grundreinigung',
                  description: 'Intensive Grundreinigung für Neubauten, nach Renovierungen oder bei starker Verschmutzung.',
                  beforeImage: 'https://images.pexels.com/photos/4099467/pexels-photo-4099467.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Zap,
                  features: ['Tiefenreinigung', 'Alle Oberflächen', 'Spezialreiniger', 'Nachbehandlung', 'Abnahmebereit'],
                  duration: '1-3 Tage',
                },
                {
                  title: 'Industriereinigung',
                  description: 'Spezialisierte Reinigung für Industrieanlagen, Werkstätten und Produktionsstätten.',
                  beforeImage: 'https://images.pexels.com/photos/4099467/pexels-photo-4099467.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Wrench,
                  features: ['Industrieanlagen', 'Werkstätten', 'Spezialreiniger', 'Sicherheitsstandards', 'Dokumentation'],
                  duration: 'Nach Vereinbarung',
                },
                {
                  title: 'Sonderreinigung',
                  description: 'Spezielle Reinigungsarbeiten wie Tatortreinigung, Schimmelbeseitigung oder Brandschadensanierung.',
                  beforeImage: 'https://images.pexels.com/photos/4099467/pexels-photo-4099467.jpeg?auto=compress&cs=tinysrgb&w=800',
                  icon: Shield,
                  features: ['Tatortreinigung', 'Schimmelbeseitigung', 'Brandschäden', 'Wasserschäden', 'Desinfektion'],
            ...
            <div className="text-center mt-12">
              <div className={`bg-gradient-to-r from-${currentTheme.primaryColor}-500/10 to-cyan-500/10 rounded-2xl p-8 border border-${currentTheme.primaryColor}-500/20`}>
                <h3 className="text-2xl font-bold mb-4 text-white font-poppins">Nicht sicher welche Reinigung Sie brauchen?</h3>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto font-poppins">
                  Unsere Reinigungs-Experten beraten Sie kostenlos und finden die perfekte Lösung für Ihre Räumlichkeiten.
                </p>
      ...
      {isAIChatbotEnabled && (
        <div className="fixed bottom-6 left-6 z-40">
          ...
          <div className="absolute bottom-16 left-0 bg-white text-gray-800 p-3 rounded-lg shadow-lg max-w-xs opacity-0 hover:opacity-100 transition-opacity duration-300">
            <p className="text-sm font-medium">Hallo! Ich bin Ihr Reinigungs-KI-Assistent. Wie kann ich Ihnen helfen?</p>
          </div>
        </div>
      )}
