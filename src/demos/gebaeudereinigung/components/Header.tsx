        ...
        <div className="flex justify-between items-center h-20">
          ...
          {!minimal && (
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <a
                href="/configurator"
                className="bg-blue-600 hover:bg-blue-700 border border-blue-600 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
          ...
          {minimal && (
            <a
              href="/configurator"
              className="bg-blue-600 hover:bg-blue-700 border border-blue-600 text-white px-4 py-2 rounded-full font-semibold transition-all duration-300 text-sm shadow-lg"
            >
