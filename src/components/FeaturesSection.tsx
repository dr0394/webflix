      ...
      <section id="designs-section" className="py-12 sm:py-16 px-4 bg-gray-100">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-500/10 to-pink-600/10 border border-pink-400/20 rounded-full mb-6">
              <span className="text-sm font-semibold bg-gradient-to-r from-pink-500 to-pink-600 bg-clip-text text-transparent">Webflix zum Mitnehmen</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 sm:mb-12 gap-4">
            <h3 className="text-left text-2xl sm:text-3xl md:text-4xl font-black bg-gradient-to-r from-pink-500 to-pink-600 bg-clip-text text-transparent">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-600 to-pink-500 text-white font-semibold rounded-lg hover:from-pink-500 hover:to-pink-400 transition-all duration-300 whitespace-nowrap"
            >
            ...
            <div className="flex gap-4 pb-4" style={{ width: 'max-content' }}>
              {features.map((feature, index) => (
                <div
                  ...
                  className="relative w-[280px] sm:w-[320px] h-[480px] sm:h-[520px] rounded-2xl overflow-hidden group cursor-pointer flex-shrink-0 border border-gray-200 hover:border-pink-400/60 transition-all duration-300 shadow-md"
                >
                  <img
                    src={feature.image}
          ...
          {/* Price Section */}
          <div className="max-w-2xl mx-auto bg-white border border-pink-500/30 rounded-2xl p-8 text-center shadow-lg">
            <div className="mb-6">
              <div className="text-5xl sm:text-6xl font-black text-gray-900 mb-2">347€</div>
              <div className="text-xl text-pink-500 font-medium">347€ Setup + Support ab 7,90€/Mo.</div>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-pink-600 to-pink-500 text-white font-bold rounded-xl hover:from-pink-500 hover:to-pink-400 transition-all duration-300 text-lg"
            >
