        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-400/10 to-emerald-400/10 border border-green-400/20 rounded-full mb-6">
              <span className="text-sm font-semibold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">349€ Paket - Alles Inklusive</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3">
              Was bekommst du für 349€?
            </h2>
            <p className="text-lg sm:text-xl text-gray-400">
              Deine komplette Website - ohne versteckte Kosten
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {features.map((feature, index) => (
              <div
                ...
                className="relative bg-white/5 backdrop-blur-sm border border-white/10 hover:border-green-500/50 rounded-2xl overflow-hidden group cursor-pointer transition-all duration-300 hover:scale-[1.02]"
              >
                <div className="p-6">
                  <div className="w-12 h-12 bg-green-500/10 border border-green-500/30 rounded-xl flex items-center justify-center mb-4 group-hover:bg-green-500/20 transition-all duration-300">
          ...
          <div className="max-w-2xl mx-auto bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-2xl p-8 text-center">
            <div className="mb-6">
              <div className="text-5xl sm:text-6xl font-black text-white mb-2">349€</div>
