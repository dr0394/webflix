    ...
    <section className="py-20 bg-gradient-to-b from-[#111111] to-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-pink-400 to-pink-500 bg-clip-text text-transparent">
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-pink-500 to-pink-400 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="mt-16 text-center">
          <button className="px-8 sm:px-12 py-4 bg-gradient-to-r from-pink-500 to-pink-400 hover:from-pink-600 hover:to-pink-500 text-white font-semibold rounded-lg text-base sm:text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-pink-500/50">
