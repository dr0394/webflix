  ...
  return (
    <section className="relative py-8 sm:py-10 md:py-12 bg-gradient-to-b from-[#111111] via-[#0a0a0a] to-[#111111] overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="group relative bg-gradient-to-br from-white/5 via-white/[0.02] to-white/5 hover:from-orange-500/20 hover:via-red-500/10 hover:to-pink-500/20 backdrop-blur-xl border-2 border-white/20 hover:border-orange-400/30 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500">
          {/* Decorative Elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-white/5 group-hover:from-orange-400/20 to-transparent rounded-full blur-3xl transition-all duration-500"></div>
          ...
          <div className="relative z-10 px-6 sm:px-8 py-6 sm:py-8 text-center">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 leading-tight">
              ...
              <span className="text-white/60 group-hover:bg-gradient-to-r group-hover:from-orange-400 group-hover:via-red-400 group-hover:to-pink-400 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-500">
                Unterstützung
              </span>{' '}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                ...
                className="relative px-6 py-3 bg-white/10 hover:bg-gradient-to-r hover:from-orange-500 hover:via-red-500 hover:to-pink-500 border-2 border-white/30 hover:border-transparent rounded-lg font-bold text-white text-sm sm:text-base transition-all duration-300 shadow-lg hover:shadow-orange-500/50 hover:scale-105 w-full sm:w-auto"
              >
            ...
            <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-white/70">
              <div className="flex items-center gap-1.5">
                <div className="w-1.5 h-1.5 bg-white/40 group-hover:bg-orange-400 rounded-full transition-colors duration-500"></div>
