...
const faqs = [
  {
    ...
    answer: "347€ einmalige Setup-Gebühr für deine Website. Technischer Support, Updates und Wartung ab 7,90€/Monat. Die Website gehört dir."
  },
  {
  ...
  },
  {
    ...
    answer: "Technischer Support, Updates und Wartung sind ab 7,90€/Monat verfügbar. Die Website gehört dir - du kannst sie jederzeit zu einem anderen Anbieter umziehen."
  }
];
  ...
  return (
    ...
    <section className="py-12 sm:py-16 px-4 bg-black">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-3 mb-12">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm border border-white/10 hover:border-pink-500/30 rounded-xl transition-all duration-300"
            >
              <button
              ...
              >
                ...
                <div className="ml-2 sm:ml-4 flex-shrink-0">
                  {openIndex === index ? (
                    <Minus size={20} className="text-pink-500 sm:w-6 sm:h-6" />
                  ) : (
                    <Plus size={20} className="text-pink-500 sm:w-6 sm:h-6" />
                  )}
                </div>
              </button>
      ...
      <section className="py-12 sm:py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center bg-gradient-to-br from-pink-500/10 to-pink-600/10 border border-pink-500/30 rounded-2xl p-8">
