      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-3 mb-12">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm border border-white/10 hover:border-green-500/30 rounded-xl transition-all duration-300"
            >
              <button
              ...
              >
                ...
                <div className="ml-2 sm:ml-4 flex-shrink-0">
                  {openIndex === index ? (
                    <Minus size={20} className="text-green-400 sm:w-6 sm:h-6" />
                  ) : (
        ...
        {/* Final CTA */}
        <div className="text-center bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-2xl p-8">
